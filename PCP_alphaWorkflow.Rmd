...
ctrPt_sf <- st_as_sf(ctrPt)
ctrCirc <-  st_buffer(ctrPt, as.numeric(maxdist/earthrad), nQuadSegs = 1)




df <- st_sfc(st_point(cbind(ctrY, ctrX)),crs=4326)
df_sf_buff <- st_buffer(df, (maxdist*10)) #meters*10
plot(df_sf_buff) 
