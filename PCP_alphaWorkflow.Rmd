...
## 04: Declare a data frame; make it an object we want to use

```{r}
class(routes)
```

## 05: Center point and test point distance
...
## 06: Calculate all distances (Great circle, X, Y)
...
## 07: Calculate all bearings to center point
...
# Base R version (not super working yet)
# filled.contour(x = flts$x,
#                y = flts$y,
#                z = flts$z,
